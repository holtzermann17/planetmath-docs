...
\item
  Versioning (after the fashion of CVS) 
  \begin{itemize}
  \item
    Each file can be stored in multiple versions. 
  \item  
    Bare name of file will refer to default version (typically latest 
    version) but other versions can be accessed by appending version 
    specifier to file name. 
  \item  
    Preserves history of editing and allows recovering data from 
    older versions. 
  \item  
    File history can be forked. 
  \item  
    Utilities to navigate history, editing  history trees, searching 
    and comparing past versions.
  \end{\itemize}  
\end{itemize}
...
\item
  ...
  \item
    ...
    \item  
      Teacher, tutor (looking for student) 
    \item 
      Researcher (looking for collaborator) 
    \end{iteemize}  
  \item
    Participation in the directory is completely voluntary and members 
    can opt in our out out of any portions as they desire.
  \end{itemize}
\item
